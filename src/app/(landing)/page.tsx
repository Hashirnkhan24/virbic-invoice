...
import TemplateRenderer, {
	TEMPLATE_META,
} from "@/components/invoice-templates/TemplateRenderer";
import {
	TemplateName,
	DEFAULT_SETTINGS,
...
const TESTIMONIALS = [
	{
		quote:
			"Virbic made GST calculations fully hands-off. I input my items, it determines CGST and SGST correctly, and my client pays instantly via the UPI QR. Absolutely brilliant product.",
		author: "Priya S.",
	...
	{
		quote:
			"No more clunky accounting sheets. Virbic is fast, clean, and lets me generate GSTR-1 summaries in one click. It has saved me hours of administrative headache.",
		author: "Rohan M.",
	...
	{
		quote:
			"I own a small marketing agency. Having multiple business profiles and generating clean invoice PDFs with our brand color makes us look extremely professional.",
		author: "Aditi K.",
		role: "Agency Founder",
		avatarLetter: "A",
	},
		...
		<div className="relative min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-x-hidden selection:bg-emerald-500/20 selection:text-emerald-700">
			...
			<section className="relative pt-24 pb-20 md:pt-36 md:pb-32 bg-gradient-to-br from-sky-50/50 via-violet-50/30 to-white dark:from-slate-950 dark:via-slate-900/40 dark:to-slate-950">
				...
				<div className="absolute inset-0 z-0 opacity-20 dark:opacity-10 pointer-events-none overflow-hidden">
					<svg
						className="absolute top-12 left-12 w-64 h-64 text-sky-400"
						viewBox="0 0 100 100"
					>
						<circle
							cx="50"
					...
					<svg
						className="absolute bottom-20 right-10 w-96 h-96 text-violet-400"
						viewBox="0 0 100 100"
					>
						<rect
							x="5"
					...
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
						...
						<div className="lg:col-span-7 space-y-6 text-left">
							...
							>
								...
								>
									Create GST-compliant, professional invoices in under 60
									seconds. Customize templates, generate dynamic payment QR
									codes, and export GSTR reports instantly.
								</motion.p>
							</motion.div>
						...
						<div className="lg:col-span-5 relative flex justify-center items-center">
							...
							>
								...
								<div className="mt-4 space-y-1">
									<div className="text-[10px] text-slate-450 uppercase tracking-wider font-bold">
										Billed To
									</div>
			...
			<section
				id="features"
				className="py-20 md:py-28 bg-slate-50/50 dark:bg-slate-900/10"
			>
				<div className="max-w-[1280px] mx-auto px-6 md:px-12">
					...
					<div className="text-center max-w-xl mx-auto mb-16 space-y-3">
						...
						<p className="text-sm text-slate-550 dark:text-slate-400">
							Forget heavy spreadsheets. Virbic is lightweight, fast, and
							engineered specifically for independent creators and agile
							business owners.
						</p>
					</div>
					...
					>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								Create, customize, and finalize a beautiful client invoice in
								under a minute. Faster than brewing a cup of coffee.
							</p>
						</motion.div>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								Input your state and your client&apos;s state. We dynamically
								calculate CGST, SGST, or IGST, generating a compliant tax
								invoice instantly.
							</p>
						</motion.div>
						...
						>
							...
							<h4 className="text-base font-bold text-slate-900 dark:text-slate-100 mb-2">
								10 Stunning Templates
							</h4>
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								From minimal and typography-focused to bold startup colors.
								Match your brand color with professional templates.
							</p>
						</motion.div>
						...
						>
							...
							<h4 className="text-base font-bold text-slate-900 dark:text-slate-100 mb-2">
								UPI QR Code Integrations
							</h4>
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								We generate a dynamic UPI payment QR code directly on the PDF.
								Clients scan using any app (GPay, PhonePe, BHIM) and pay
								instantly.
							</p>
						</motion.div>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								Bill clients monthly? Set up recurring schedules. We&apos;ll
								automatically draft and queue the invoices for your approval.
							</p>
						</motion.div>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
								Download a clean, structured tax summary grouped by client GSTIN
								and HSN codes, making GSTR-1 filings simple and error-free.
							</p>
						</motion.div>
					</motion.div>
				</div>
					...
					<div className="relative grid grid-cols-1 md:grid-cols-3 gap-12">
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
								Upload your logo, key in your GSTIN/PAN details, choose your
								brand color, and configure defaults. Takes under 2 minutes.
							</p>
						</motion.div>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
								Add line items, select your client details, customize template,
								and review the live preview on screen. Takes 1 minute.
							</p>
						</motion.div>
						...
						>
							...
							<p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed max-w-xs">
								Share a secure public link, download the PDF, or send via email.
								Clients pay directly via the integrated UPI QR code.
							</p>
						</motion.div>
					</div>
				</div>
				...
				<div className="max-w-[1280px] mx-auto px-6 md:px-12">
					...
					<div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-16 gap-4">
						<div className="space-y-2">
							...
							<p className="text-sm text-slate-500">
								10 professionally designed templates. Pick one, choose a brand
								color, done.
							</p>
						</div>
						<Link
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
						...
						<div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 rounded-2xl p-6 flex flex-col shadow-sm">
							<div className="space-y-1 mb-6">
								<h4 className="text-xs font-black text-slate-450 tracking-wider">
									FREE
								</h4>
							...
							<ul className="space-y-3.5 text-xs text-slate-650 dark:text-slate-400 mb-8 flex-1">
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-emerald-500 flex-shrink-0" /> 5
									invoices/month
								</li>
								<li className="flex items-center gap-2">
								...
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-emerald-500 flex-shrink-0" /> 1
									business profile
								</li>
							</ul>
							<Link
						...
						>
							...
							<div className="space-y-1 mb-6">
								<h4 className="text-xs font-black text-emerald-100 tracking-wider">
									PRO
								</h4>
								<div className="text-4xl font-extrabold text-white">
									₹399
									<span className="text-xs text-emerald-250 font-normal">
										/mo
									</span>
								</div>
							...
							<ul className="space-y-3 text-xs text-emerald-50 mb-8 flex-1">
								...
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" /> All 10
									templates
								</li>
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" /> Custom
									colors & branding
								</li>
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" />{" "}
								...
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" /> Payment
									reminders
								</li>
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" />{" "}
								...
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" /> Dynamic
									UPI QR Codes
								</li>
								<li className="flex items-center gap-2">
									<Check className="w-4 h-4 text-white flex-shrink-0" />{" "}
									Analytics & GSTR reports
								</li>
							</ul>
							<Link
								href={getStartedUrl}
			...
			<section className="py-20 md:py-24 bg-emerald-600 text-white relative overflow-hidden">
				...
				<div className="absolute inset-0 opacity-10 pointer-events-none">
					<svg
						className="absolute top-1/2 left-10 w-24 h-24 text-white"
						viewBox="0 0 100 100"
					>
						<polygon
					...
					<svg
						className="absolute top-10 right-20 w-16 h-16 text-white animate-spin"
				...
				<div className="max-w-[1280px] mx-auto px-6 md:px-12 relative z-10 text-center space-y-6">
					...
					<p className="text-sm sm:text-base text-emerald-100 max-w-lg mx-auto leading-relaxed">
						Join over 2,000 freelancers, consultants, and agencies who get paid
						faster with Virbic.
					</p>
			...
			<footer className="border-t border-slate-900 bg-[#090d16] py-16 text-sm text-slate-400">
				<div className="max-w-[1280px] mx-auto px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
					...
					<div className="space-y-4">
						...
						<p className="text-xs text-slate-400 leading-relaxed max-w-xs">
							Beautiful invoices. Zero GST headaches. Engineered for Indian
				...
				<div className="max-w-[1280px] mx-auto px-6 md:px-12 mt-12 pt-8 border-t border-slate-900 text-center text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4">
					<span>
						&copy; {new Date().getFullYear()} Virbic. All rights reserved. Made
					...
					<span>
						...
						<a
							...
							className="inline-flex items-center gap-1 font-bold underline text-slate-455 hover:text-sky-400 transition-colors"
						>
							<img
								src="/amplivate-logo.svg"
								alt="Amplivate Logo"
				...
				<DialogContent className="flex flex-col gap-0 p-0 sm:max-w-4xl max-h-[90vh] overflow-hidden bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-800">
					<DialogHeader className="p-4 border-b border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-row items-center justify-between gap-4 flex-shrink-0">
						...
						<div className="flex items-center gap-3 pr-8">
							<span className="text-xs font-black text-slate-550 dark:text-slate-400 uppercase tracking-widest text-[9px]">
								Style:
							</span>
							<select
								value={previewTemplate}
								onChange={(e) =>
									setPreviewTemplate(e.target.value as TemplateName)
								}
						...
						<div className="flex items-center gap-3 w-full sm:w-auto justify-end">
							<DialogClose
								render={
									<Button
										variant="outline"
										className="h-9 font-bold px-4 text-xs cursor-pointer"
									/>
								}
							>
								Cancel
